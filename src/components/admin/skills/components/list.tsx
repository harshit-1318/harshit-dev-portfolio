...
import { SkillCardItem } from "./card-item";
...
export function SkillsList({
  ...
  const renderedCategories = Array.from(
    new Set([...categories, ...Object.keys(groupedSkills)])
  ).filter((cat) => groupedSkills[cat] && groupedSkills[cat].length > 0);
