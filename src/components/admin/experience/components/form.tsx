...
import { X, Briefcase, Loader2, Save } from "lucide-react";
import { motion } from "framer-motion";
import type { IExperience } from "@/types";
import { ExperienceFormFields } from "./form-fields";
...
export function ExperienceForm({
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-blue-500 via-primary to-cyan-500" />
          ...
          >
            {saving ? (
              ...
              <>
                ...
                <span>{editingId ? 'Update Experience' : 'Save Experience'}</span>
              </>
            )}
          </button>
        </div>
