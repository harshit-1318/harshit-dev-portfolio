...
export function HeroImpactMetrics({ variants }: HeroImpactMetricsProps) {
  const metrics = [
    { icon: Zap, text: "20+ Reusable UI Modules", color: "text-indigo-500" },
    { icon: Activity, text: "15+ RESTful Endpoints", color: "text-purple-500" },
    { icon: ShieldCheck, text: "480+ Vitest Unit Tests", color: "text-emerald-500" },
  ];
