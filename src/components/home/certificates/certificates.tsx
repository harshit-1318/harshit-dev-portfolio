...
import { CertificatesHeader } from "./components/header";
import { CertificatesSidebar } from "./components/sidebar";
import { CertificatesGrid } from "./components/grid";
import { CertificateModal } from "./components/modal";
