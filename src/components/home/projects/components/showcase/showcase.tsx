...
import { ProjectBrowserFrame } from "../browser-frame";
import { ArchitectureDrawer } from "../architecture-drawer";
import { ProjectMetricsGrid } from "../metrics-grid";
import { ProjectShowcaseActions } from "./actions";
import { ProjectShowcaseInfo } from "./info";
import { ProjectStackPills } from "../stack-pills";
import { ProjectMobileNav } from "./mobile-nav";
import type { ProjectItem } from "../../types/project-types";
import type { ProjectCategoryFilter } from "../filter";
