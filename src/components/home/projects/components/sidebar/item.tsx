...
import { ProjectStackPills } from "../stack-pills";
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        isSelected
          ? "border-indigo-500/40 bg-indigo-500/10 dark:bg-indigo-500/15 shadow-2xs"
          : "border-slate-200/80 dark:border-white/10 bg-slate-50/50 dark:bg-white/5 hover:border-indigo-500/30 hover:bg-slate-100/80 dark:hover:bg-white/10"
      )}
    >
      {isSelected && (
        <motion.div
          layoutId="activeProjectSidebarBar"
      ...
      <div className="flex items-start justify-between gap-1.5">
        ...
        <div
          className={cn(
            "p-1 rounded-full transition-all duration-200 shrink-0 mt-0.5",
            isSelected
